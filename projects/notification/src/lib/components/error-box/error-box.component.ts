...
import { ButtonComponent, ExpandableTextComponent, TaModalComponent, TextComponent, TitleComponent } from '@ta/ui';
...
@Component({
  ...
  standalone: true,
  imports: [ButtonComponent, ExpandableTextComponent, JsonPipe, TaModalComponent, TextComponent, TitleComponent],
})
/** Liste des erreurs serveur ; sans entrée ni résultat. */
export class ErrorBoxModal extends TaBaseModal<null, null> {
