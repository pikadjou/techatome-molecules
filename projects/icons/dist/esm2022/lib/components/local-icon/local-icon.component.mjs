...
export class LocalIconComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: LocalIconComponent, deps: [{ token: i1.TaIconsService }, { token: i2.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component }); }
