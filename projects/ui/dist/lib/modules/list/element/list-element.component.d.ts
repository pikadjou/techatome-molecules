...
export declare class ListElementComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ListElementComponent, "ta-list-element", never, { "withSeparator": { "alias": "withSeparator"; "required": false; "isSignal": true; }; "highlight": { "alias": "highlight"; "required": false; "isSignal": true; }; "flexColumn": { "alias": "flexColumn"; "required": false; "isSignal": true; }; }, { "action": "action"; }, never, ["ta-list-title", "ta-list-sub-title", "ta-list-tag", "ta-list-extra-information"], true, never>;
}
