...
import * as i1 from "./title/list-title.component";
import * as i2 from "./element/list-element.component";
import * as i3 from "./list-container/list-container.component";
import * as i4 from "./sub-title/list-sub-title.component";
import * as i5 from "./tag/list-tag.component";
import * as i6 from "./extra-information/list-extra-information.component";
/**
