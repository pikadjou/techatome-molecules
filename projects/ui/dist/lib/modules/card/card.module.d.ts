...
import * as i2 from "../../components/ui/ui.module";
import * as i3 from "@ta/icons";
import * as i4 from "./card.component";
import * as i5 from "./header/card-header.component";
import * as i6 from "./title/card-title.component";
import * as i7 from "./subtitle/card-subtitle.component";
import * as i8 from "./cta/card-cta.component";
import * as i9 from "./tag/card-tag.component";
import * as i10 from "./content/card-content.component";
import * as i11 from "./dashboard/dashboard.component";
import * as i12 from "./card-image/card-image.component";
/**
