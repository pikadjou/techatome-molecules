...
class ButtonComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "18.2.14", type: ButtonComponent, isStandalone: true, selector: "ta-button", inputs: { state: { classPropertyName: "state", publicName: "state", isSignal: true, isRequired: false, transformFunction: null }, type: { classPropertyName: "type", publicName: "type", isSignal: true, isRequired: false, transformFunction: null }, size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null }, icon: { classPropertyName: "icon", publicName: "icon", isSignal: true, isRequired: false, transformFunction: null }, options: { classPropertyName: "options", publicName: "options", isSignal: true, isRequired: false, transformFunction: null }, stopPropagationActivation: { classPropertyName: "stopPropagationActivation", publicName: "stopPropagationActivation", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { action: "action" }, ngImport: i0, template: "<button\n  appStopPropagation\n  [stopPropagationActivation]=\"this.stopPropagationActivation()\"\n  type=\"button\"\n  class=\"button pointer\"\n  [ngClass]=\"this.getClass()\"\n  (click)=\"handleClick()\"\n>\n  <div class=\"flex-row g-space-sm align-center\">\n    @if (this.icon()) {\n    <ta-font-icon [name]=\"this.icon()!\"></ta-font-icon>\n    }\n    <ng-content></ng-content>\n  </div>\n</button>\n", styles: [".button{width:100%;border:none;border-radius:var(--ta-components-button-radius);padding:var(--ta-components-button-padding-vertical) var(--ta-components-button-padding-horizontal);font-size:var(--ta-font-body-md-default-size);font-weight:var(--ta-font-body-md-default-weight);font-weight:var(--ta-components-button-font-weight);letter-spacing:var(--ta-components-button-letter-spacing);align-items:center;display:flex;justify-content:center;margin:auto;gap:var(--ta-components-button-gap);cursor:pointer;transition:all var(--ta-transition-base)}.button:focus-visible{outline:2px solid var(--ta-border-brand-primary);outline-offset:2px}.button.small{font-size:var(--ta-font-body-sm-default-size);font-weight:var(--ta-font-body-sm-default-weight);padding:var(--ta-components-button-small-padding-vertical) var(--ta-components-button-small-padding-horizontal)}.button.large{padding:var(--ta-components-button-large-padding-vertical) var(--ta-components-button-large-padding-horizontal)}.button.no-border{border:none}.button.disabled,.button.inactive{cursor:not-allowed}.button.primary{color:var(--ta-components-button-primary-color);background-color:var(--ta-components-button-primary-background);box-shadow:var(--ta-shadow-brand-sm)}.button.primary:hover:not(.disabled):not(.inactive){color:var(--ta-components-button-primary-hover-color);background-color:var(--ta-components-button-primary-hover-background);border:1px solid var(--ta-components-button-primary-hover-border);box-shadow:var(--ta-shadow-brand-md);transform:translateY(-1px)}.button.primary.disabled{color:var(--ta-components-button-primary-disabled-color);background-color:var(--ta-components-button-primary-disabled-background);box-shadow:none}.button.primary.inactive{color:var(--ta-components-button-primary-inactive-color);background-color:var(--ta-components-button-primary-inactive-background);box-shadow:none}.button.secondary{color:var(--ta-components-button-secondary-color);background-color:var(--ta-components-button-secondary-background);border:1.5px solid var(--ta-components-button-secondary-border);box-shadow:var(--ta-shadow-black-sm)}.button.secondary:hover:not(.disabled):not(.inactive){border-color:var(--ta-components-button-secondary-hover-border);box-shadow:var(--ta-shadow-black-md);transform:translateY(-1px)}.button.secondary.disabled{color:var(--ta-components-button-secondary-disabled-color);border-color:var(--ta-components-button-secondary-disabled-border);box-shadow:none}.button.secondary.inactive{border-color:var(--ta-components-button-secondary-inactive-border);box-shadow:none}.button.secondary ta-font-icon{color:var(--ta-components-button-secondary-icon-color)}.button.tertiary{color:var(--ta-components-button-tertiary-color);background-color:var(--ta-components-button-tertiary-background);border:1.5px solid var(--ta-components-button-tertiary-border)}.button.tertiary:hover:not(.disabled):not(.inactive){color:var(--ta-components-button-tertiary-hover-color);background-color:var(--ta-components-button-tertiary-hover-background);border-color:var(--ta-components-button-tertiary-hover-border)}.button.tertiary.disabled{color:var(--ta-components-button-tertiary-disabled-color);border-color:var(--ta-components-button-tertiary-disabled-border)}.button.tertiary.inactive{color:var(--ta-components-button-tertiary-inactive-color);background-color:var(--ta-components-button-tertiary-inactive-background)}.circular{height:var(--ta-components-button-circular-height);width:var(--ta-components-button-circular-width);border-radius:var(--ta-components-button-circular-radius);padding:var(--ta-components-button-circular-padding)}.circular.big{height:var(--ta-components-button-circular-big-height);width:var(--ta-components-button-circular-big-width)}.circular.small{height:var(--ta-components-button-circular-small-height);width:var(--ta-components-button-circular-small-width)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "component", type: FontIconComponent, selector: "ta-font-icon", inputs: ["name", "type"] }, { kind: "directive", type: StopPropagationDirective, selector: "[appStopPropagation]", inputs: ["stopPropagationActivation"] }] }); }
}
...
class ToastComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "18.2.14", type: ToastComponent, isStandalone: true, selector: "ta-toast", inputs: { code: { classPropertyName: "code", publicName: "code", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<div class=\"card\" [ngClass]=\"this.getTypeClass(this.code())\">\n  <ng-content></ng-content>\n</div>\n", styles: [".card{box-shadow:var(--ta-shadow-black-md);border-radius:var(--ta-radius-rounded);overflow:hidden;padding:var(--ta-space-lg);background-color:var(--ta-surface-primary);color:var(--ta-text-primary);font-size:var(--ta-font-body-md-default-size);font-weight:var(--ta-font-body-md-default-weight)}.card.success{border-left:4px solid var(--ta-semantic-token-success)}.card.danger{border-left:4px solid var(--ta-semantic-token-alert)}.card.warning{border-left:4px solid var(--ta-semantic-token-warning)}.card.info{border-left:4px solid var(--ta-semantic-token-link)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] }); }
}
