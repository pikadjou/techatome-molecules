...
import { Component, Injectable, input, EventEmitter, Output, ViewChild, ViewEncapsulation, CUSTOM_ELEMENTS_SCHEMA, Inject, inject, InjectionToken, Injector, Optional, ContentChild } from '@angular/core';
...
class OverlayService extends TaBaseService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.14", ngImport: i0, type: OverlayService, deps: [{ token: i1$4.Overlay }, { token: i0.Injector }], target: i0.ɵɵFactoryTarget.Injectable }); }
