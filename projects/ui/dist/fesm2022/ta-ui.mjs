...
import { isNonNullable, StopPropagationDirective, Civility, PluralTranslatePipe, TaBaseComponent, extractExtension, roundToDecimal, octetsToMo, getCountryName, TaBaseModal, createRange } from '@ta/utils';
...
class LabelComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "18.2.14", type: LabelComponent, isStandalone: true, selector: "ta-label", inputs: { size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null }, type: { classPropertyName: "type", publicName: "type", isSignal: true, isRequired: false, transformFunction: null }, icon: { classPropertyName: "icon", publicName: "icon", isSignal: true, isRequired: false, transformFunction: null }, shape: { classPropertyName: "shape", publicName: "shape", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<span class=\"label-container align-center\" [ngClass]=\"this.getClass()\">\r\n  @if (this.icon(); as icon) {\r\n    <ta-font-icon [name]=\"icon\" type=\"sm\"></ta-font-icon>\r\n  }\r\n  <ng-content></ng-content>\r\n</span>\r\n", styles: [":host{display:flex}.label-container{padding:var(--ta-components-label-padding-vertical) var(--ta-components-label-padding-horizontal);font-size:var(--ta-font-body-sm-default-size);font-weight:var(--ta-font-body-sm-default-weight);font-weight:var(--ta-components-label-font-weight);letter-spacing:var(--ta-components-label-letter-spacing);border-radius:var(--ta-components-label-radius);border:1px solid transparent;gap:var(--ta-space-xs)}.label-container ta-font-icon{flex-shrink:0;color:inherit}.label-container.pill{border-radius:var(--ta-radius-pill)}.label-container.xs{padding:var(--ta-components-label-xs-padding-vertical) var(--ta-components-label-xs-padding-horizontal);font-size:var(--ta-font-body-xs-default-size);font-weight:var(--ta-font-body-xs-default-weight)}.label-container.sm{padding:var(--ta-components-label-sm-padding-vertical) var(--ta-components-label-sm-padding-horizontal);font-size:var(--ta-font-body-sm-default-size);font-weight:var(--ta-font-body-sm-default-weight)}.label-container.lg{padding:var(--ta-components-label-lg-padding-vertical) var(--ta-components-label-lg-padding-horizontal);font-size:var(--ta-font-body-md-default-size);font-weight:var(--ta-font-body-md-default-weight)}.label-default{color:var(--ta-components-label-default-color);background:var(--ta-components-label-default-background);border-color:var(--ta-components-label-default-border)}.label-secondary{color:var(--ta-components-label-secondary-color);background:var(--ta-components-label-secondary-background);border-color:var(--ta-components-label-secondary-border)}.label-success{color:var(--ta-components-label-success-color);background:var(--ta-components-label-success-background);border-color:var(--ta-components-label-success-border)}.label-warning{color:var(--ta-components-label-warning-color);background:var(--ta-components-label-warning-background);border-color:var(--ta-components-label-warning-border)}.label-alert{color:var(--ta-components-label-alert-color);background:var(--ta-components-label-alert-background);border-color:var(--ta-components-label-alert-border)}.label-purple{color:var(--ta-components-label-purple-color);background:var(--ta-components-label-purple-background);border-color:var(--ta-components-label-purple-border)}.label-neutral{color:var(--ta-components-label-neutral-color);background:var(--ta-components-label-neutral-background);border-color:var(--ta-components-label-neutral-border)}\n"], dependencies: [{ kind: "component", type: FontIconComponent, selector: "ta-font-icon", inputs: ["name", "type"] }, { kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] }); }
}
...
class DataGridComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "18.2.14", type: DataGridComponent, isStandalone: true, selector: "ta-data-grid", inputs: { columns: { classPropertyName: "columns", publicName: "columns", isSignal: true, isRequired: false, transformFunction: null }, orientation: { classPropertyName: "orientation", publicName: "orientation", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<div class=\"data-grid\" [ngClass]=\"this.getClass()\">\r\n  <ng-content></ng-content>\r\n</div>\r\n", styles: [":host{display:block}.data-grid{display:grid;grid-template-columns:1fr;gap:1px;background:var(--ta-surface-default);border:1px solid var(--ta-surface-default);border-radius:var(--ta-radius-label);overflow:hidden}@media screen and (min-width: 577px){.data-grid.columns-2{grid-template-columns:repeat(2,minmax(0,1fr))}.data-grid.columns-3{grid-template-columns:repeat(3,minmax(0,1fr))}.data-grid.columns-4{grid-template-columns:repeat(4,minmax(0,1fr))}}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.14", ngImport: i0, type: DataGridComponent, decorators: [{
            type: Component,
            args: [{ selector: 'ta-data-grid', standalone: true, imports: [NgClass], template: "<div class=\"data-grid\" [ngClass]=\"this.getClass()\">\r\n  <ng-content></ng-content>\r\n</div>\r\n", styles: [":host{display:block}.data-grid{display:grid;grid-template-columns:1fr;gap:1px;background:var(--ta-surface-default);border:1px solid var(--ta-surface-default);border-radius:var(--ta-radius-label);overflow:hidden}@media screen and (min-width: 577px){.data-grid.columns-2{grid-template-columns:repeat(2,minmax(0,1fr))}.data-grid.columns-3{grid-template-columns:repeat(3,minmax(0,1fr))}.data-grid.columns-4{grid-template-columns:repeat(4,minmax(0,1fr))}}\n"] }]
        }] });
...
class DataGridItemComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "18.2.14", type: DataGridItemComponent, isStandalone: true, selector: "ta-data-grid-item", inputs: { icon: { classPropertyName: "icon", publicName: "icon", isSignal: true, isRequired: false, transformFunction: null }, label: { classPropertyName: "label", publicName: "label", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<div class=\"data-grid-item\">\r\n  <span class=\"data-grid-item-label\">\r\n    @if (this.icon(); as icon) {\r\n      <ta-font-icon [name]=\"icon\" type=\"sm\"></ta-font-icon>\r\n    }\r\n    <span class=\"data-grid-item-label-text\">{{ this.label() }}</span>\r\n  </span>\r\n  <span class=\"data-grid-item-value\">\r\n    <ng-content></ng-content>\r\n  </span>\r\n</div>\r\n", styles: [":host{display:block;min-width:0}.data-grid-item{height:100%;box-sizing:border-box;padding:var(--ta-space-md);background:var(--ta-surface-primary)}.data-grid-item-label{flex-wrap:nowrap;display:flex;align-items:center;gap:var(--ta-space-sm);min-width:0;color:var(--ta-icon-secondary)}.data-grid-item-value{display:block;color:var(--ta-text-primary);overflow-wrap:break-word}:host-context(.data-grid-row) .data-grid-item{flex-wrap:nowrap;align-items:center;display:flex;flex-direction:row;justify-content:space-between;gap:var(--ta-space-md)}:host-context(.data-grid-row) .data-grid-item-label-text{font-size:var(--ta-font-body-sm-default-size);font-weight:var(--ta-font-body-sm-default-weight);color:var(--ta-text-tertiary)}:host-context(.data-grid-row) .data-grid-item-value{font-size:var(--ta-font-body-sm-default-size);font-weight:var(--ta-font-body-sm-bold-weight);font-family:var(--ta-font-display-family);text-align:right}:host-context(.data-grid-stack) .data-grid-item{display:flex;flex-direction:column;gap:var(--ta-space-xs)}:host-context(.data-grid-stack) .data-grid-item-label-text{font-family:var(--ta-font-display-family);font-size:var(--ta-font-body-xs-default-size);font-weight:var(--ta-font-body-sm-bold-weight);line-height:1;letter-spacing:.12em;text-transform:uppercase;color:var(--ta-text-tertiary)}:host-context(.data-grid-stack) .data-grid-item-value{font-size:var(--ta-font-body-md-default-size);font-weight:var(--ta-font-body-md-default-weight);font-weight:var(--ta-font-weight-medium);line-height:1.4}:host-context(.data-grid-fact) .data-grid-item{display:flex;flex-direction:column;gap:var(--ta-space-xs)}:host-context(.data-grid-fact) .data-grid-item-label{display:contents}:host-context(.data-grid-fact) ta-font-icon{order:0;color:var(--ta-icon-accent)}:host-context(.data-grid-fact) .data-grid-item-value{order:1;font-family:var(--ta-font-display-family);font-size:var(--ta-font-body-md-default-size);font-weight:var(--ta-font-body-md-bold-weight);line-height:1;letter-spacing:-.02em}:host-context(.data-grid-fact) .data-grid-item-label-text{order:2;font-size:var(--ta-font-body-sm-default-size);font-weight:var(--ta-font-body-sm-default-weight);line-height:1;color:var(--ta-text-muted)}\n"], dependencies: [{ kind: "component", type: FontIconComponent, selector: "ta-font-icon", inputs: ["name", "type"] }] }); }
}
