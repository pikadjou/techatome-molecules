import { NgClass, NgTemplateOutlet, NgIf, NgFor, AsyncPipe, NgStyle, CommonModule } from '@angular/common';
import * as i0 from '@angular/core';
import { Injectable, ViewChild, Input, Component, inject, Inject, EventEmitter, Output, NgModule } from '@angular/core';
import { TaBaseComponent, CamAbstractComponent, isNonNullable, CamDirectivePipeModule } from '@ta/utils';
...
class MainMenuComponent extends TaBaseComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "18.2.13", type: MainMenuComponent, isStandalone: true, selector: "ta-main-menu", inputs: { menuMain: "menuMain", menuUser: "menuUser" }, usesInheritance: true, ngImport: i0, template: "<div class=\"main-nav-container\">\n  <div class=\"main-nav\">\n    <div class=\"logo\">\n      <ta-logo class=\"small\"></ta-logo>\n      <ta-logo class=\"oneline\" [type]=\"'oneline'\"></ta-logo>\n    </div>\n    <div class=\"menu-nav\">\n      <ta-menu class=\"menu\" [menu]=\"this.menuMain\" [container]=\"'main'\"></ta-menu>\n    </div>\n    @if (this.menuUser) {\n      <div class=\"user-nav\">\n        <div class=\"sep\"></div>\n        <ta-menu class=\"menu\" [menu]=\"this.menuUser\" [container]=\"'main'\"></ta-menu>\n      </div>\n    }\n    @if ((this.breakpoints.isMobile$ | async) === false) {\n      <div class=\"expansion-nav\" (click)=\"this.toggleView()\">\n        <ta-font-icon\n          class=\"d-flex\"\n          name=\"arrow-double\"\n          [ngClass]=\"(this.sharedMenu.isMinimized$ | async) ? 'close' : 'open'\"\n        ></ta-font-icon>\n      </div>\n    }\n  </div>\n</div>\n", styles: ["@media screen and (min-width: 576px){.main-nav-container{position:sticky;top:0;height:100vh;display:flex}}.main-nav-container .expansion-nav{display:none}@media screen and (min-width: 1200px){.main-nav-container:hover .expansion-nav{display:block}}.main-nav{display:flex;flex-flow:column;padding:var(--ta-space-sm) var(--ta-space-sm) 0 var(--ta-space-sm);padding-bottom:calc(var(--ta-space-sm) + env(safe-area-inset-bottom));border-radius:3px 3px 0 0;background-color:var(--ta-surface-primary);box-shadow:0 4px 6px -1px #0000001a,0 2px 4px -1px #0000000f}@media screen and (max-width: 575px){.main-nav{display:flex;flex-direction:row;justify-content:space-between;overflow-x:auto}}@media screen and (min-width: 576px){.main-nav{border-radius:0 3px 3px 0;padding:var(--ta-components-header-top) var(--ta-space-sm) 0 var(--ta-space-sm);padding-bottom:calc(var(--ta-space-sm) + env(safe-area-inset-bottom));align-content:space-between;background-color:var(--ta-brand-900)}}@media screen and (min-width: 992px){.main-nav{padding:var(--ta-components-header-top) var(--ta-space-md) 0 var(--ta-space-md);padding-bottom:calc(var(--ta-space-md) + env(safe-area-inset-bottom))}}.main-nav .logo{margin:auto}@media screen and (max-width: 575px){.main-nav .logo{display:none}}@media screen and (min-width: 576px){.main-nav .logo{margin-bottom:var(--ta-space-lg);width:48px}.main-nav .logo .small{display:block}.main-nav .logo .oneline{display:none}}@media screen and (min-width: 992px){.main-nav .logo{margin-left:0;margin-bottom:var(--ta-space-xxl);width:190px}.main-nav .logo .small{display:none}.main-nav .logo .oneline{display:block}}.main-nav.menu-minimized .logo{margin-left:auto!important;width:48px!important}.main-nav.menu-minimized .logo .small{display:block!important}.main-nav.menu-minimized .logo .oneline{display:none!important}.main-nav .menu-nav,.main-nav .menu-nav .menu{flex:1}@media screen and (max-width: 575px){.main-nav .user-nav{display:none}}.main-nav .user-nav .sep{border-bottom:1px solid var(--ta-surface-brand-primary);margin:var(--ta-space-sm)}.expansion-nav{position:absolute;bottom:15px;right:-20px;color:var(--ta-icon-invert-primary);border-radius:var(--ta-radius-full);background-color:var(--ta-surface-brand-primary);padding:var(--ta-space-sm)}.expansion-nav .open,.expansion-nav .close{transition-duration:.8s;transition-property:transform}.expansion-nav .close{transform:rotate(180deg)}\n"], dependencies: [{ kind: "directive", type: NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "pipe", type: AsyncPipe, name: "async" }, { kind: "component", type: FontIconComponent, selector: "ta-font-icon", inputs: ["name", "type"] }, { kind: "component", type: LogoComponent, selector: "ta-logo", inputs: ["color", "type", "widthPercentage"] }, { kind: "component", type: MenuComponent, selector: "ta-menu", inputs: ["menu", "container"] }] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: MainMenuComponent, decorators: [{
            type: Component,
            args: [{ selector: 'ta-main-menu', standalone: true, imports: [NgIf, NgClass, AsyncPipe, FontIconComponent, LogoComponent, MenuComponent], template: "<div class=\"main-nav-container\">\n  <div class=\"main-nav\">\n    <div class=\"logo\">\n      <ta-logo class=\"small\"></ta-logo>\n      <ta-logo class=\"oneline\" [type]=\"'oneline'\"></ta-logo>\n    </div>\n    <div class=\"menu-nav\">\n      <ta-menu class=\"menu\" [menu]=\"this.menuMain\" [container]=\"'main'\"></ta-menu>\n    </div>\n    @if (this.menuUser) {\n      <div class=\"user-nav\">\n        <div class=\"sep\"></div>\n        <ta-menu class=\"menu\" [menu]=\"this.menuUser\" [container]=\"'main'\"></ta-menu>\n      </div>\n    }\n    @if ((this.breakpoints.isMobile$ | async) === false) {\n      <div class=\"expansion-nav\" (click)=\"this.toggleView()\">\n        <ta-font-icon\n          class=\"d-flex\"\n          name=\"arrow-double\"\n          [ngClass]=\"(this.sharedMenu.isMinimized$ | async) ? 'close' : 'open'\"\n        ></ta-font-icon>\n      </div>\n    }\n  </div>\n</div>\n", styles: ["@media screen and (min-width: 576px){.main-nav-container{position:sticky;top:0;height:100vh;display:flex}}.main-nav-container .expansion-nav{display:none}@media screen and (min-width: 1200px){.main-nav-container:hover .expansion-nav{display:block}}.main-nav{display:flex;flex-flow:column;padding:var(--ta-space-sm) var(--ta-space-sm) 0 var(--ta-space-sm);padding-bottom:calc(var(--ta-space-sm) + env(safe-area-inset-bottom));border-radius:3px 3px 0 0;background-color:var(--ta-surface-primary);box-shadow:0 4px 6px -1px #0000001a,0 2px 4px -1px #0000000f}@media screen and (max-width: 575px){.main-nav{display:flex;flex-direction:row;justify-content:space-between;overflow-x:auto}}@media screen and (min-width: 576px){.main-nav{border-radius:0 3px 3px 0;padding:var(--ta-components-header-top) var(--ta-space-sm) 0 var(--ta-space-sm);padding-bottom:calc(var(--ta-space-sm) + env(safe-area-inset-bottom));align-content:space-between;background-color:var(--ta-brand-900)}}@media screen and (min-width: 992px){.main-nav{padding:var(--ta-components-header-top) var(--ta-space-md) 0 var(--ta-space-md);padding-bottom:calc(var(--ta-space-md) + env(safe-area-inset-bottom))}}.main-nav .logo{margin:auto}@media screen and (max-width: 575px){.main-nav .logo{display:none}}@media screen and (min-width: 576px){.main-nav .logo{margin-bottom:var(--ta-space-lg);width:48px}.main-nav .logo .small{display:block}.main-nav .logo .oneline{display:none}}@media screen and (min-width: 992px){.main-nav .logo{margin-left:0;margin-bottom:var(--ta-space-xxl);width:190px}.main-nav .logo .small{display:none}.main-nav .logo .oneline{display:block}}.main-nav.menu-minimized .logo{margin-left:auto!important;width:48px!important}.main-nav.menu-minimized .logo .small{display:block!important}.main-nav.menu-minimized .logo .oneline{display:none!important}.main-nav .menu-nav,.main-nav .menu-nav .menu{flex:1}@media screen and (max-width: 575px){.main-nav .user-nav{display:none}}.main-nav .user-nav .sep{border-bottom:1px solid var(--ta-surface-brand-primary);margin:var(--ta-space-sm)}.expansion-nav{position:absolute;bottom:15px;right:-20px;color:var(--ta-icon-invert-primary);border-radius:var(--ta-radius-full);background-color:var(--ta-surface-brand-primary);padding:var(--ta-space-sm)}.expansion-nav .open,.expansion-nav .close{transition-duration:.8s;transition-property:transform}.expansion-nav .close{transform:rotate(180deg)}\n"] }]
...
class NavigationComponent extends CamAbstractComponent {
    constructor() {
        super();
        this.swiper = false;
        this.options = {};
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.13", ngImport: i0, type: NavigationComponent, decorators: [{
            type: Component,
            args: [{ selector: 'ta-menu-navigation', standalone: true, imports: [NgIf, NgFor, NgClass, NgTemplateOutlet, RouterModule, TranslateModule, FontIconComponent, NotificationBadgeComponent, NotificationBadgeContainerComponent, SwiperLightComponent], template: "<div class=\"navigation-container\" [class]=\"this.container\">\n  <div class=\"list\">\n    @if (this.swiper) {\n      <ta-swiper-light\n        [items]=\"this.menu.elements\"\n        [template]=\"template\"\n        [forced]=\"true\"\n        [swiperClasses]=\"this.getSpaceClass()\"\n      ></ta-swiper-light>\n    } @else {\n      <div class=\"element-list\" [ngClass]=\"this.menu.direction + ' ' + this.getSpaceClass()\">\n        @for (element of this.menu.elements; track element) {\n          <div class=\"element\">\n            <ng-template\n              [ngTemplateOutlet]=\"template\"\n              [ngTemplateOutletContext]=\"{\n                element: element,\n              }\"\n            >\n            </ng-template>\n          </div>\n        }\n      </div>\n    }\n  </div>\n</div>\n\n<ng-template #template let-element=\"element\">\n  <ta-notification-badge-container class=\"c-pointer\">\n    @if (element.callback || element.disabled) {\n      <div\n        (click)=\"this.callback(element)\"\n        class=\"item-container\"\n        [ngClass]=\"{ active: this.isActive(element), disabled: element.disabled }\"\n      >\n        <ng-template\n          [ngTemplateOutlet]=\"Item\"\n          [ngTemplateOutletContext]=\"{\n            item: element,\n          }\"\n        >\n        </ng-template>\n      </div>\n    } @else {\n      <div\n        class=\"item-container\"\n        routerLinkActive=\"active\"\n        [routerLinkActiveOptions]=\"{ exact: element.exact }\"\n        [routerLink]=\"[this.getLink(element)]\"\n        [queryParamsHandling]=\"element.queryParamsHandling\"\n      >\n        <ng-template\n          [ngTemplateOutlet]=\"Item\"\n          [ngTemplateOutletContext]=\"{\n            item: element,\n          }\"\n        >\n        </ng-template>\n      </div>\n    }\n    @if (element.options?.notificationBadge?.label) {\n      <ta-notification-badge\n        [number]=\"element.options?.notificationBadge?.label || 0\"\n        [style]=\"element.options?.notificationBadge?.style\"\n        fontSize=\"xs\"\n      ></ta-notification-badge>\n    }\n  </ta-notification-badge-container>\n</ng-template>\n\n<ng-template #Item let-item=\"item\" [typedTemplate]=\"this.typeItem\">\n  <div class=\"item\" [class.disabled]=\"item.disabled\">\n    @if (this.hasFontIcon(item)) {\n      <div class=\"icon\">\n        <ta-font-icon [name]=\"this.getFontIcon(item)\"></ta-font-icon>\n      </div>\n    }\n    @if (item.label) {\n      <div class=\"label\">\n        {{ item.label | translate }}\n      </div>\n    }\n    @if (item.translationData?.length) {\n      <div class=\"bullet\">({{ item.translationData?.length }})</div>\n    }\n  </div>\n</ng-template>\n", styles: [".element-list{gap:var(--ta-space-md);display:flex;flex-direction:row}.element-list.vertical{display:flex;flex-direction:column}.tags .item-container .item{flex-direction:row;display:flex;align-items:center;gap:var(--ta-space-xs);padding:var(--ta-space-md);border:1px solid transparent;color:var(--ta-text-tertiary);background-color:var(--ta-surface-tertiary);border-color:var(--ta-surface-tertiary);border-radius:var(--ta-radius-rounded);font-size:var(--ta-font-body-sm-default-size);line-height:var(--ta-font-body-sm-default-line);font-weight:var(--ta-font-body-sm-default-weight)}.tags .item-container.disabled .item{background-color:var(--ta-surface-primary);border-color:var(--ta-border-disabled)}.tags .item-container.active .item{color:var(--ta-text-brand-primary);background-color:var(--ta-surface-default);border-color:var(--ta-surface-default)}.tab .list{border-bottom:1px solid var(--ta-border-secondary)}.tab .item-container .item{flex-direction:row;display:flex;align-items:center;gap:var(--ta-space-xs);padding:var(--ta-space-md);border-bottom:2px solid transparent;color:var(--ta-text-tertiary);font-size:var(--ta-font-body-sm-default-size);line-height:var(--ta-font-body-sm-default-line);font-weight:var(--ta-font-body-sm-default-weight)}.tab .item-container.disabled{opacity:.5}.tab .item-container.active .item{color:var(--ta-text-brand-primary);border-bottom-color:var(--ta-border-brand)}:host ::ng-deep .swiper-container{gap:var(--ta-space-sm)!important}:host ::ng-deep ta-font-icon{margin-top:-6px;display:block}:host ::ng-deep ta-font-icon i{height:18px!important;font-size:18px!important}\n"] }]
        }], ctorParameters: () => [], propDecorators: { menu: [{
                type: Input
            }], container: [{
                type: Input
