...
export declare class TypedTemplateDirective<TypeToken> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<TypedTemplateDirective<any>, "ng-template[typedTemplate]", never, { "typedTemplate": { "alias": "typedTemplate"; "required": false; }; }, {}, never, never, false, never>;
}
