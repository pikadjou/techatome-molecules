...
import { input, Component, inject, LOCALE_ID, Injectable, Optional, Inject, output } from '@angular/core';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.14", ngImport: i0, type: LinkComponent, decorators: [{
            type: Component,
            args: [{ selector: "ta-rich-paragraph-link", standalone: true, imports: [LinkComponent$1, TextComponent], template: "@for (entity of this.link().children; track entity) {\n<ta-link (action)=\"this.goTo()\">\n  @switch (entity.type) { @case ('text') {\n  <ta-rich-paragraph-text [text]=\"$any(entity)\"></ta-rich-paragraph-text>\n  } }\n</ta-link>\n}\n", styles: ["ta-link{display:inline-block}\n"] }]
        }] });
