...
2. **La référence détaillée `references/project/<name>.md` n'existe pas encore** — fie-toi au catalogue ci-dessous et, au besoin, aux sources du paquet (`projects/features/project/`).
