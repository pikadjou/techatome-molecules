---
description: Bonnes pratiques Angular pour techatome/techatome — conventions de code, routing, formulaires, menus, layout, AG Grid, services GraphQL, loading/error/empty
