...
**Règle** : ces mixins sont **obligatoires**. `display: flex;` suivi de `flex-direction`, `justify-content` ou
`align-items` écrit à la main dans un `.component.scss` est un écart de revue.
