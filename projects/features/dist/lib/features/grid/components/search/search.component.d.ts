...
export declare class TaGridSearchComponent extends TaAbstractGridComponent<any> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TaGridSearchComponent, "ta-grid-search", never, { "outOfBox": { "alias": "outOfBox"; "required": false; "isSignal": true; }; }, {}, never, never, true, never>;
}
