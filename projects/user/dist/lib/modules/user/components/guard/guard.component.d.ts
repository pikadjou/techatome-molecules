...
export declare class GuardComponent extends TaAbstractComponent {
    ...
    preview: import("@angular/core").InputSignal<boolean>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GuardComponent, "ta-guard", never, { "level": { "alias": "level"; "required": false; "isSignal": true; }; "feature": { "alias": "feature"; "required": false; "isSignal": true; }; "role": { "alias": "role"; "required": false; "isSignal": true; }; "canDisplayErrorMessage": { "alias": "canDisplayErrorMessage"; "required": false; "isSignal": true; }; "preview": { "alias": "preview"; "required": false; "isSignal": true; }; }, {}, never, ["*"], true, never>;
}
