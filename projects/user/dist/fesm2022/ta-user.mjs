...
import { CardComponent, CardContentComponent, ButtonComponent, LoaderComponent, ErrorComponent, EmptyComponent, InlineProfileDataComponent, ListContainerComponent, ListElementComponent, ListTagComponent, ListTitleComponent } from '@ta/ui';
...
class SwitchLanguageCtaComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "18.2.14", type: SwitchLanguageCtaComponent, isStandalone: true, selector: "ta-switch-language-cta", ngImport: i0, template: `<ta-switch-language mode="dropdown"></ta-switch-language>`, isInline: true, dependencies: [{ kind: "component", type: SwitchLanguageComponent, selector: "ta-switch-language", inputs: ["mode"] }] }); }
}
