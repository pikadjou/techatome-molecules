...
class CheckboxComponent extends TaAbstractInputComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "18.2.14", type: CheckboxComponent, isStandalone: true, selector: "ta-input-checkbox", usesInheritance: true, ngImport: i0, template: "<div class=\"custom-checkbox align-center g-space-xs\">\n  <input\n    type=\"checkbox\"\n    #focusedElement\n    (click)=\"this.input.value = !this.input.value\"\n    [checked]=\"this.input.value\"\n    [attr.aria-invalid]=\"this.input.formControl?.invalid\"\n    [disabled]=\"this.input.disabled\"\n  />\n  <ta-form-label\n    [input]=\"this.input\"\n    [withMarginBottom]=\"false\"\n  ></ta-form-label>\n</div>\n", styles: [".custom-checkbox{border-color:var(--ta-border-tertiary);border-radius:5px;transition:border-color var(--ta-transition-fast),box-shadow var(--ta-transition-fast)}.custom-checkbox:hover{border-color:var(--ta-border-brand-primary)}.input{border-radius:5px;transition:all var(--ta-transition-fast)}.input:checked{background-color:var(--ta-surface-brand-primary);border-color:var(--ta-surface-brand-primary)}.input:not(:disabled){border-color:var(--ta-border-tertiary)}.input:not(:disabled):hover{border-color:var(--ta-border-brand-primary)}.input:focus-visible{outline:2px solid var(--ta-border-brand-primary);outline-offset:2px;box-shadow:0 0 0 3px #121e381a}\n"], dependencies: [{ kind: "component", type: FormLabelComponent, selector: "ta-form-label", inputs: ["input", "withMarginBottom"] }] }); }
}
