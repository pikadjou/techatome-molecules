...
export declare class ComponentSelectorModal extends TaBaseModal<InputComponent, string> {
    readonly selectedValue$: Subject<string>;
    constructor();
    select(value: string): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<ComponentSelectorModal, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ComponentSelectorModal, "ta-component-selector-modal", never, {}, {}, never, never, true, never>;
}
export declare class ComponentInputComponent extends TaAbstractInputComponent<InputComponent> {
    selectorModal: ModalState<InputComponent, string>;
    open(): void;
