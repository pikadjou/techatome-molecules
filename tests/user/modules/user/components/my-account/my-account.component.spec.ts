...
import { MyAccountComponent } from '@lib/user/modules/user/components/my-account/my-account.component';
import { TA_AUTH_TOKEN } from '@lib/user/modules/user/services/auth.service';
import { TA_USER_SERVICE } from '@lib/user/modules/user/services/user.service';
