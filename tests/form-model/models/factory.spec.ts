import { InputFactory } from '@lib/form-model/models/factory';
import { InputCheckBox } from '@lib/form-model/models/input/checkbox';
import { InputColorPicker } from '@lib/form-model/models/input/colorPicker';
import { InputDropdown } from '@lib/form-model/models/input/dropdown';
import { InputImages } from '@lib/form-model/models/input/images';
import { InputLabel } from '@lib/form-model/models/input/label';
import { InputLogo } from '@lib/form-model/models/input/logo';
import { InputNumber } from '@lib/form-model/models/input/number';
import { InputPanel } from '@lib/form-model/models/input/panel';
import { InputRadio } from '@lib/form-model/models/input/radio';
import { InputSchema } from '@lib/form-model/models/input/schema';
import { InputTextarea } from '@lib/form-model/models/input/textarea';
import { InputTextBox } from '@lib/form-model/models/input/textbox';
import { InputUpload } from '@lib/form-model/models/input/upload';
import { InputWysiswyg } from '@lib/form-model/models/input/wysiswyg';
