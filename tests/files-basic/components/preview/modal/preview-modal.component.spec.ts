...
import { PreviewModal } from '@lib/files-basic/components/preview/modal/preview-modal.component';
import { PreviewDocumentDto } from '@lib/files-basic/components/preview/type';
