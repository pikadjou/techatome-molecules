...
export class NotificationShowcaseComponent {
  ...
  showSuccess() {
    this.notificationService.success('Opération réussie !', 'Votre action a été exécutée avec succès.');
  }

  showInfo() {
    this.notificationService.info('Information', 'Voici une notification d\'information.');
  }
