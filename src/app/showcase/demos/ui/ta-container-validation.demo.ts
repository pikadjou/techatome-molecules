...
export const DEMO: ComponentDemo = {
  ...
  group: 'Overlays',
  summary:
    "Enrobe un contenu projeté (typiquement un bouton) d'une confirmation ouverte au clic — en modale, ou dans le flux.",
  examples: [
    {
    ...
    },
    {
      title: 'Désactivé',
      description:
        "`disabled` bloque l'ouverture de la modale (`openModal()` retourne immédiatement) sans changer l'apparence du contenu projeté.",
