...
export const chartsRoutes: Routes = [
  {
    ...
    loadComponent: () => import('./pages/showcase/showcase.component').then((c) => c.ChartsShowcasePage),
  },
  {
    path: TaRoutes.getUrl([EChartsRoute.charts, EChartsRoute.barChart]),
    loadComponent: () => import('./pages/bar-chart/bar-chart.component').then((c) => c.BarChartPage),
  },
  {
    path: TaRoutes.getUrl([EChartsRoute.charts, EChartsRoute.lineChart]),
    loadComponent: () => import('./pages/line-chart/line-chart.component').then((c) => c.LineChartPage),
  },
  {
    path: TaRoutes.getUrl([EChartsRoute.charts, EChartsRoute.pieChart]),
    loadComponent: () => import('./pages/pie-chart/pie-chart.component').then((c) => c.PieChartPage),
  },
  {
    path: TaRoutes.getUrl([EChartsRoute.charts, EChartsRoute.doughnutChart]),
    loadComponent: () => import('./pages/doughnut-chart/doughnut-chart.component').then((c) => c.DoughnutChartPage),
  },
];