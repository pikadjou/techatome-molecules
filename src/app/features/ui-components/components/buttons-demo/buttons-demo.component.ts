...
export class ButtonComponent {
  ...
  buttonTypes = [
    ...
    { name: 'Secondary', class: 'btn-secondary', description: 'Action secondaire' },
    { name: 'Success', class: 'btn-success', description: 'Action de validation' },
    { name: 'Warning', class: 'btn-warning', description: 'Action d\'avertissement' },
