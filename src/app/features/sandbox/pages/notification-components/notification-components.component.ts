    ...
    <div class="sandbox-page">
      ...
      <div class="components-container">
        <mat-card class="component-section">
          <mat-card-header>
            <mat-card-title>Système de Notifications</mat-card-title>
            <mat-card-subtitle>Section en cours de développement</mat-card-subtitle>
          </mat-card-header>
          <mat-card-content>
            <p>Les composants de notification sont en cours d'intégration dans le sandbox.</p>
            <p>Composants disponibles dans &#64;ta/notification :</p>
            <ul>
              <li>NotificationBoxComponent - Notifications popup</li>
              <li>NotificationInlineComponent - Notifications intégrées</li>
              <li>NotificationService - Service de gestion des notifications</li>
            </ul>
          </mat-card-content>
        </mat-card>
      </div>
